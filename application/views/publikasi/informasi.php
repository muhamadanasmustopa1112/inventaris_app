...
<body>
	...
	<div class="jumbotron jumbotron-fluid text-center" style="background-image: url('<?= base_url('image/bg.jpg'); ?>'); height:400px;">
		<div class="container" style="color: white;">
			<h1 class="display-4">Publikasi Informasi</h1>
			<p class="lead">Aplikasi Layanan Publikasi Informasi Majalengka</p>
		</div>
	</div>
	<div class="container mt-4">
		<h2 class="text-center">Data Aplikasi Publikasi Informasi</h2>
		<div class="card">
							...
							<tr>
								...
								<td>
									...
									<form action="<?= base_url('publikasi/detail') ?>" method="POST">
										...
										<button class="badge badge-primary" type="submit" name="informasi">Detail</button>
									</form>
								</td>
							</tr>
						<?php } ?>
