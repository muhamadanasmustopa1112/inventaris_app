...
<body>
	...
	<div class="jumbotron jumbotron-fluid text-center" style="background-image: url('<?= base_url('image/bg.jpg'); ?>'); height:400px;">
		<div class="container" style="color: white;">
			...
			<p class="lead">Aplikasi Layanan Pembayaran Majalengka</p>
		</div>
	</div>
	<div class="container mt-4">
		<h2 class="text-center">Data Aplikasi Pembyararn</h2>
		<div class="card">
							...
							<tr>
								...
								<td>
									...
									<form action="<?= base_url('publikasi/detail') ?>" method="POST">
										<input type="hidden" value="pembayaran" />
										<input type="hidden" value="<?= $d->id ?>" name="id" />
										<button class="badge badge-primary" name="pelaporan" type="submit">Detail</button>
									</form>
								</td>
							</tr>
						<?php } ?>
