...
<body>
	...
	<div class="jumbotron jumbotron-fluid text-center" style="background-image: url('<?= base_url('image/bg.jpg'); ?>'); height:400px;">
		<div class="container" style="color: white;">
			...
			<p class="lead">Aplikasi Layanan Pendaftaran Majalengka</p>
		</div>
	</div>
	<div class="container mt-4">
		<h2 class="text-center">Data Aplikasi Pendaftaran</h2>
		<div class="card">
							...
							<tr>
								...
								<td>
									...
									<form action="<?= base_url('publikasi/detail') ?>" method="POST">
										<input type="hidden" value="pendaftaran" />
										<input type="hidden" value="<?= $d->id ?>" name="id" />
										<button class="badge badge-primary" name="pendaftaran" type="submit">Detail</button>
									</form>
								</td>
							</tr>
						<?php } ?>
