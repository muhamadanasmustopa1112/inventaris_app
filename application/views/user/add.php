				...
				<div class="container-fluid">
					<button type="button" class="btn btn-primary" id="softwere">Softwere</button>
					<button type="button" class="btn btn-primary" id="hardwere">Hardwere</button>
						...
						<div class="card-body">
							<div class="row">
								...
								<div class="col-9 border border-primary">
									<form class="data" method="post" action="<?= base_url('user/add'); ?>" enctype="multipart/form-data">
										<div class="tab-content" id="v-pills-tabContent">
											...
											<div class="tab-pane fade" id="v-pills-profil" role="tabpanel" aria-labelledby="v-pills-messages-tab">
												...
												<div class="form-group">
													...
													<input type="number" value="<?= set_value('kode_pos'); ?>" name="kode_pos" id="tambah_kode_pos" class="form-control">
													<?= form_error('kode_pos', '<small class="text-danger ml-3">', '</small>') ?>

												</div>
												<div class="form-group">
													<label for="recipient-name" class="col-form-label">Nomer Telepon:</label>
													<input type="number" value="<?= set_value('no_telp'); ?>" name="no_telp" id="tambah_no_telp" class="form-control">
					...
					<div class="card mt-3 " id="perangkat_keras" style="display: none;">
						<div class="card-header">Add Perangkat Keras</div>
						<div class="card-body">
							<div class="row">
								<form action="<?= base_url('user/add_hardwere') ?>" method="POST">
									<div class="col-md-7">

										<input class="form-control" type="hidden" value="<?= $user['id'] ?>" name="id">

										<label for="namaPerangkatKeras" class="col-form-label">Nama Perangkat Keras:</label>
										<input class="form-control" type="text" id="namaPerangkatKeras" placeholder="Nama Hardwere" name="nama_perangkat" aria-label="default input example">
									</div>

									<div class="col-md-7 mt-2">
										<label for="jumlah" class="col-form-label">Jumlah:</label>
										<input class="form-control" name="jumlah" type="number" id="jumlah" placeholder="Jumlah" aria-label="default input example">

										<button type="submit" class="btn btn-primary ml-auto mt-3" id="softwere">Add Data</button>
