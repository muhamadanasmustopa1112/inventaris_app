						...
						?>
							<tr>
								...
								<td>
									...
									<form action="<?= base_url('ruanglingkupcontroller/delete_data') ?>" method="POST">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form method="POST" action="<?= base_url('ruanglingkupcontroller/edit_data'); ?>">
...
<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="POST" action="<?= base_url('ruanglingkupcontroller/add_data'); ?>">
					...
					<div class="form-group">
						<label for="recipient-name" class="col-form-label">Ruang Lingkup:</label>
						<textarea class="form-control" name="ruang_lingkup" id="tambah_ruang" rows="3" placeholder="Sesuai dengan UU 25 tahun 2009"></textarea>
					</div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
