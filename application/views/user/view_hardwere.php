						...
						?>
							<tr>
								...
								<td>
									...
									<form action="<?= base_url('hardwere/delete_data') ?>" method="POST">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form method="POST" action="<?= base_url('hardwere/edit_data'); ?>">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="POST" action="<?= base_url('hardwere/add'); ?>">
					...
					<div class="form-group">
						<label for="recipient-name" class="col-form-label">Jenis :</label>
						<input type="text" name="jenis" id="tambah_jenis" class="form-control">
					</div>
					<div class="form-group">
						<label for="recipient-name" class="col-form-label">Pemilik:</label>
						<textarea class="form-control" name="pemilik" id="tambah_pemilik" rows="3"></textarea>
					</div>
					<div class="form-group">
						<label for="recipient-name" class="col-form-label">Penyedia Data Center :</label>
						<input type="text" name="penyedia" id="tambah_penyedia" class="form-control">
					</div>
					<div class="form-group">
						<label for="recipient-name" class="col-form-label">Band Width :</label>
						<input type="text" name="bandwidth" id="tambah_bandwidth" class="form-control">
					</div>

					<div class="form-group">
						<label for="recipient-name" class="col-form-label">Jumlah :</label>
						<input type="number" name="jumlah" id="tambah_jumlah" class="form-control">
					</div>
					<div class="form-group">
						<label for="recipient-name" class="col-form-label">Tipe :</label>
						<input type="text" name="tipe" id="tambah_tipe" class="form-control">
					</div>
					<div class="form-group">
						<label for="recipient-name" class="col-form-label">Keterangan:</label>
						<input type="text" name="keterangan_hardwere" id="tambah_keterangan" class="form-control">
