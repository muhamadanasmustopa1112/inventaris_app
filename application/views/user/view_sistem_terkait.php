										...
										?>
											<tr>
												...
												<td>
													...
													<form action="<?= base_url('sistemterkait/delete_data') ?>" method="POST">
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									<form method="POST" action="<?= base_url('sistemterkait/edit_data'); ?>">
				...
				<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form method="POST" action="<?= base_url('sistemterkait/add_data'); ?>">
									...
									<div class="form-group">
										...
										<div class="row">
											<div class="col">
												<textarea class="form-control" name="sistem_terkait" id="tambah_sistem" rows="3" placeholder="Nama Sistem Terkait"></textarea>
											</div>
											<div class="col">
												<textarea class="form-control" name="keterangan_terkait" id="tambah_keterangan" rows="3" placeholder="Keterangan"></textarea>
											</div>
										</div>
									</div>
							</div>
