				...
				<div style="overflow-x:auto;" class="container-fluid">
					...
					<div class="card">
						<div class="card-header">Sistem Keamanan</div>
						<div class="card-body">
							<div class="row">
								<div class="col text-right mb-2">
									<button type="button" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#addModal"><i class="fas mr-2 fa-plus"></i> Sistem Keamanan</button>
								</div>
							</div>
								...
								<table id="table_umum" class="table table-bordered" style="width:100%">
									<thead>
										<tr>
											...
											<th scope="col">Sistem Pengamanan</th>
										...
										?>
											<tr>
												...
												<td>
													...
													<form action="<?= base_url('sistemkeamanan/delete_data') ?>" method="POST">
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									<form method="POST" action="<?= base_url('sistemkeamanan/edit_data'); ?>">
										...
										<div class="form-group">
											...
											<div class="row">
												<div class="col">
													<textarea class="form-control" name="sistem_pengamanan" id="tambah_pengamanan" rows="3" placeholder="Nama Sistem Pengamanan"><?= $d->sistem_pengamanan ?></textarea>
												</div>
												<div class="col">
													<textarea class="form-control" name="keterangan_keamanan" id="tambah_keterangan" rows="3" placeholder="Keterangan"><?= $d->keterangan ?></textarea>
												</div>
											</div>
										</div>
								</div>
				...
				<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form method="POST" action="<?= base_url('sistemkeamanan/add_data'); ?>">
									...
									<div class="form-group">
										...
										<div class="row">
											<div class="col">
												<textarea class="form-control" name="sistem_pengamanan" id="tambah_pengamanan" rows="3" placeholder="Nama Sistem Pengamanan"></textarea>
											</div>
											<div class="col">
												<textarea class="form-control" name="keterangan_keamanan" id="tambah_keterangan" rows="3" placeholder="Keterangan"></textarea>
											</div>
										</div>
									</div>
							</div>
