										...
										<tr>
											...
											<td>
												<button type="button" class="btn badge bg-warning" data-bs-toggle="modal" data-bs-target="#editModal<?= $d->id ?>" style="color: white;">
													Edit </button>
												<form action="<?= base_url('fiturcontroller/delete_data') ?>" method="POST">
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									<form method="POST" action="<?= base_url('fiturcontroller/edit_data'); ?>">
										...
										<div class="form-group">
											...
											<div class="row">
												<div class="col">
													<textarea class="form-control" name="nama_fitur" rows="3" id="tambah_fungsi"><?= $d->nama_fitur ?></textarea>
												</div>
												<div class="col">
													<textarea class="form-control" name="keterangan_fitur" rows="3" id="tambah_keterangan"><?= $d->keterangan_fitur ?></textarea>
												</div>
											</div>
										</div>
								</div>
				...
				<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form method="POST" action="<?= base_url('fiturcontroller/add_data'); ?>">
									...
									<div class="form-group">
										...
										<div class="row">
											<div class="col">
												<textarea class="form-control" name="nama_fitur" rows="3" id="tambah_fungsi"></textarea>
											</div>
											<div class="col">
												<textarea class="form-control" name="keterangan_fitur" rows="3" id="tambah_keterangan"></textarea>
											</div>
										</div>
									</div>
							</div>
