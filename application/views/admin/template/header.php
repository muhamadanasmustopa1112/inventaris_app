...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<!-- Nav Item - Pages Collapse Menu -->
			<li class="nav-item">
				<a class="nav-link" href="<?= base_url('ticketing') ?>">
					<i class="fas fa-folder-plus"></i>
					<span>Ticketing</span>
				</a>
			</li>
			...
			<li class="nav-item">
				<a class="nav-link" href="<?= base_url('admin/log_activity') ?>">
					<i class="fas fa-folder-plus"></i>
			...
			<li class="nav-item">
				...
				<div id="collapseDataApplication" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="<?= base_url('hardwere') ?>">Hardware</a>
			...
			<li class="nav-item">
				<a class="nav-link" href="<?= base_url('admin/hardwere') ?>">
					<i class="fas fa-folder-plus"></i>
					<span>Hardwere</span>
				</a>
			</li>
