										...
										?>
											<tr>
												...
												<td>
													...
													<form action="<?= base_url('sistemkeamanan/delete') ?>" method="POST">
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									<form method="POST" action="<?= base_url('sistemkeamanan/edit'); ?>">
										...
										<div class="form-group">
											...
											<div class="row">
												<div class="col">
													<textarea class="form-control" name="sistem_pengamanan" id="tambah_pengamanan" rows="3" placeholder="Nama Sistem Pengamanan"><?= $d->sistem_pengamanan ?><?= set_value('sistem_pengamanan') ?></textarea>
													<?= form_error('sistem_pengamanan', '<small class="text-danger ml-3">', '</small>') ?>
												</div>
												<div class="col">
													<textarea class="form-control" name="keterangan_keamanan" id="tambah_keterangan" rows="3" placeholder="Keterangan"><?= $d->keterangan ?><?= set_value('keterangan_keamanan') ?></textarea>
				...
				<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form method="POST" action="<?= base_url('sistemkeamanan/add'); ?>">
