				...
				<div class="container-fluid">
								...
								<table id="example" class="table table-bordered" width="100%">
									<thead>
										<tr>
											...
											<th scope="col">Aksi Verifikasi</th>
										</tr>
									</thead>
									<tbody>
										<?php
											...
											?>
												...
												<tr>
													...
													<td>
														...
														<form action="<?= base_url('dataumum/verifiy_application') ?>" method="POST">

															<input type="hidden" name="id" value="<?= $d->id ?>">
															<button class="btn badge bg-success" style="color: white;">Approve</button>
														</form>


														<button class="btn badge bg-danger" data-bs-toggle="modal" data-bs-target="#declineModal<?= $d->id ?>" style="color: white;">Decline</button>
					...
					<div class="card mt-4">
						<div class="card-header">Table Verifikasi</div>
						<div class="card-body">
							<div class="row">
								<div class="col text-right mb-2">
									<form action="<?= base_url('dataumum/print') ?>" method="POST">
							...
							<div class="table-responsive">
								...
								<table id="table_verifikasi" class="table table-bordered" width="100%">
									<thead>
										<tr>
											<th scope="col">No</th>
											<th scope="col">Nama Internal</th>
									...
									<tbody>
										...
										?>
											...
											if ($d->status == "Decline" || $d->status == "Accept") {
													...
													<td>
														<div class="row">
															<div class="col mb-2">
																...
																<form action="<?= base_url('admin/edit_all') ?>" method="POST">
								...
								<div class="modal-body">
									<form method="POST" action="<?= base_url('dataumum/edit'); ?>">
										...
										<div class="form-group">
											...
											<textarea class="form-control" name="keterangan" rows="3"><?= $d->keteangan ?></textarea>
				...
				<!-- Modal Decline Data -->
				<?php foreach ($data as $d) : ?>
					<div class="modal fade" id="declineModal<?= $d->id ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title" id="exampleModalLabel">Edit Data</h5>
								...
								<div class="modal-body">
									<form method="POST" action="<?= base_url('dataumum/decline_application'); ?>">
										<div class="form-group">
											<label for="recipient-name" class="col-form-label">Keterangan Decline:</label>
