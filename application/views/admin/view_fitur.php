						...
						<div class="card-body">
							<div class="row">
								<div class="col mb-3 text-right">
									<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addModal"><i class="fas mr-2 fa-plus"></i>Add Fitur</button>
								</div>
							</div>
										...
										<tr>
											...
											<td>
												<button type="button" class="btn badge bg-warning" data-bs-toggle="modal" data-bs-target="#editModal<?= $d->id ?>" style="color: white;">
													Edit </button>
												<form action="<?= base_url('fiturcontroller/delete') ?>" method="POST">
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									<form method="POST" action="<?= base_url('fiturcontroller/edit'); ?>">
										...
										<div class="form-group">
											...
											<div class="row">
												<div class="col">
													<textarea class="form-control" name="nama_fitur" rows="3" id="tambah_fungsi"><?= $d->nama_fitur ?><?= set_value('nama_fitur') ?></textarea>
													<?= form_error('nama_fitur', '<small class="text-danger ml-3">', '</small>') ?>

												</div>
												<div class="col">
													<textarea class="form-control" name="keterangan_fitur" rows="3" id="tambah_keterangan"><?= $d->keterangan_fitur ?><?= set_value('keterangan_fitur') ?></textarea>
				...
				<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form method="POST" action="<?= base_url('fiturcontroller/add'); ?>">
									...
									<div class="form-group">
										...
										<div class="row">
											<div class="col">
												<textarea class="form-control" name="nama_fitur" rows="3" id="tambah_fungsi"><?= set_value('nama_fitur') ?></textarea>
												<?= form_error('nama_fitur', '<small class="text-danger ml-3">', '</small>') ?>

											</div>
											<div class="col">
												<textarea class="form-control" name="keterangan_fitur" rows="3" id="tambah_keterangan"><?= set_value('keterangan_fitur') ?></textarea>
												<?= form_error('keterangan_fitur', '<small class="text-danger ml-3">', '</small>') ?>
